...
import { getSearchParam } from 'renderer/utils/getSearchParam';
import { postMessageToTop } from 'renderer/utils/messaging';
import { transform } from 'renderer/utils/babel';
import tryEval from 'renderer/utils/evaluate';
  ...
  const fetchComponent = useCallback(
    async (code: string) => {
      ...
      try {
        ...
        const transformedCode = (transform(code).code || '').replaceAll(
          '/*#__PURE__*/',
          ''
        );
